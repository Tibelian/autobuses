        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("localizador") != null){
                ...
                if(compraLocalizada == null){
                    response.sendRedirect("./error.jsp?code=No se ha encontrado ninguna compra con el localizador " + localizador + ", tenga en cuenta una vez finalizado el viaje no podrá localizarlo");
                    return;
                }
