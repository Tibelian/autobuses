                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle d-flex">
                                        ...
                                        <form id="form-<%= tarjeta.getId() %>" onsubmit="confirmarPago(this, '<%= tarjeta.getTipo() %>', <%= reserva.getRuta().getPrecio() * reserva.getViajeros().size() %>, <%= tarjeta.getCvv() %>); return false;" method="post" action="./confirmarPago?id=<%= tarjeta.getId() %>">
